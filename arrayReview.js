...
var capitalize = function (sentence) {
  ...
  var otherLetters = sentence.slice(1).toLowerCase();
  var fullWord = firstChar + otherLetters;
  return fullWord;
}
...
var vowelCounter = function(str) {
  var total = 0;
  var splitSen = str.split("");
  console.log(splitSen);
  for (var i = 0; i < splitSen.length; i++) {
    if (splitSen[i] === "a" || splitSen[i] === "e" || splitSen[i] === "i" || splitSen[i] === "o" || splitSen[i] === "u") {
      total += 1;   
    }
}
return total
